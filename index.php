...
// 3. Fetch Student Data if logged in
...
<head>
    ...
    <style>
        ...
        /* CRITICAL FIX: Ensure search items are horizontal */
        ...
        <div class="student-card section">
            <div style="text-align: center;">
                ...
                <form action="upload_handler.php" method="POST" enctype="multipart/form-data" class="upload-form">
                    <label for="p_img" class="file-label"><i class="fas fa-camera"></i> Change</label>
                    <input type="file" name="profile_pix" id="p_img" hidden onchange="this.form.submit()">
                </form>
            </div>
            <div style="flex-grow: 1;">
                ...
                <form method="GET" style="margin-top: 15px;">
                    <select name="semester" onchange="this.form.submit()" style="padding: 8px; border-radius: 8px; background: var(--container-bg); color: var(--text-color); border: 1px solid var(--border-color);">
